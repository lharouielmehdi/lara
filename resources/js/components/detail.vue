      ...
      <div class="col-md-12">
        ...
        <div class="card-header">
          ...
          <div class="card-tools">
            ...
            <button>
              <router-link to="/Request">POST'S</router-link>
          ...
          <form @submit.prevent="mode ? UpdatePost() : detail()">
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <br v-show="!mode" />
                <strong>{{form.owner_phone }}</strong>
                <input
                  v-show="mode"
...
export default {
  ...
  methods: {
    ...
    loadComponent() {
      axios.get("api/detail").then(({ data }) => (this.posts = data));
    },
